...
public class CodeGenerator
{
	...
	private static void write(Writer writer, String format) throws IOException
	{
		writer.write(format);
	}

	private static void write(Writer writer, String format, Object... args) throws IOException
	{
